...
I am <b>Arda Bahrul Ulum</b>, like things in the field of programming especially in the field of web application development with focus in Back End, for PHP using Laravel Framework with JQuery using database MySQL, PostgreSQL and SQL Server. I have an expertise in that field and have work experience in the field of web application development. In addition, i once took a web development certification from the ministry of communication and informatics (Kominfo). To find out more about me & feel free to connect with me here:
